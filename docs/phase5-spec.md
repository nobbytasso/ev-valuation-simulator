...
> | U-23 | ポートフォリオ時価の定義(EVベース、netDebt控除なし) | P5-2 の裁定を転記 | 裁定後に確定 |
> | U-24 | 未紐付け銘柄の評価(コスト評価 or 除外) | P5-1 の裁定を転記 | 裁定後に確定 |

(医療機器 implied マルチプルを P5-7 で採用する場合は、バックログ節の記載どおり独立バッチとしてエンジン・Python・golden・キー集合比較の4点セットを別途起こす。本書のコミット列には含めない。)

---

## 8. 未確定事項一覧(ユーザー裁定待ち)

実装セッションは全項目の裁定を受領してから着手する。**金額の意味に関わるのは P5-1〜P5-4**。
...
> Phase 5-B(実装)セッション冒頭に貼る。《裁定》の箇所はユーザーの P5-1〜P5-9 裁定結果で置換してから使用する。
...
- P5-1: 《裁定》 / P5-2: 《裁定》 / P5-3: 《裁定》 / P5-4: 《裁定》 / P5-5: 《裁定》 / P5-6: 《裁定》 / P5-7: 《裁定》 / P5-8: 《裁定》 / P5-9: 《裁定》
