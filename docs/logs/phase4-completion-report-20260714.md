...
**追記(2026-07-14)**: この限定事項の解消のため Playwright 1.61.1 + Chromium が導入された。再実行手順・実ブラウザ確認チェックリストは `docs/logs/phase4-test-rerun-instructions-20260714.md` を参照(自動テスト323件Greenの再確認とスクリーンショットスモークまで実施済み)。
